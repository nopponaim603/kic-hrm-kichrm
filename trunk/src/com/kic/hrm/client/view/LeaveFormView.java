...
public class LeaveFormView extends Composite{
	...
	public LeaveFormView() {
		...
		verticalPanelLeavingForm.add(flexTable);
		...
		verticalPanelLeavingForm.add(verticalPanel_1);
		...
		verticalPanelLeavingForm.add(verticalPanel_2);
		...
		verticalPanelLeavingForm.add(horizontalPanel_3);
		...
		verticalPanelLeavingForm.add(horizontalPanel_5);
		...
		verticalPanelLeavingForm.add(horizontalPanel_4);
		...
		verticalPanelLeavingForm.add(horizontalPanel_6);
