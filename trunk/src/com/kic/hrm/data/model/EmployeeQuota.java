...
public class EmployeeQuota implements Serializable{
	...
	/**
	 * @param m_ontime the m_ontime to set
	 */
	...
	/**
	 * @param m_onsite the m_onsite to set
	 */
	...
	/**
	 * @param m_absence the m_absence to set
	 */
	...
	/**
	 * @param m_late the m_late to set
	 */
	...
	/**
	 * @param m_leave the m_leave to set
	 */
	...
	/**
	 * @param m_holiday the m_holiday to set
	 */
