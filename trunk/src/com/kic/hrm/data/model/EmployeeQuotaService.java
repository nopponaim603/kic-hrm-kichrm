...
public class EmployeeQuotaService {
	...
	public static EmployeeQuota AddDataEmployeeQuota(Entity entity) {
		...
		m_employeeQuota.setM_ontime(Integer.parseInt(Long.toString((Long)entity.getProperty(property.ontime.toString()))));
		m_employeeQuota.setM_onsite(Integer.parseInt(Long.toString((Long)entity.getProperty(property.onsite.toString()))));
		
		m_employeeQuota.setM_late(Integer.parseInt(Long.toString((Long)entity.getProperty(property.late.toString()))));
		m_employeeQuota.setM_absence(Integer.parseInt(Long.toString((Long)entity.getProperty(property.absence.toString()))));
		
		m_employeeQuota.setM_leave(Integer.parseInt(Long.toString((Long)entity.getProperty(property.leave.toString()))));
		m_employeeQuota.setM_holiday(Integer.parseInt(Long.toString((Long)entity.getProperty(property.holiday.toString()))));
	...
	public static Entity FlashData(Entity entity , EmployeeQuota m_employee) {
		...
		entity.setProperty(property.absence.toString(), m_employee.getM_absence());
		
		entity.setProperty(property.leave.toString(), m_employee.getM_leave());
		entity.setProperty(property.holiday.toString(), m_employee.getM_holiday());
	...
	public static Filter findEmployeeByEmployeeID(int employeeID) {
		Filter m_emailFilter =
				  new FilterPredicate(EmployeeQuota.property.employeeID.toString(),
