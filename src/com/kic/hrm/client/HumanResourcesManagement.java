...
public class HumanResourcesManagement implements EntryPoint {
	...
	public void onModuleLoad() {
						...
						grid_1.setWidget(0, 1, label_2);
								...
								grid_1.setWidget(1, 0, label_3);
										...
										grid_1.setWidget(2, 0, label_5);
												...
												Label label_6 = new Label("\u0E1E\u0E19\u0E31\u0E01\u0E07\u0E32\u0E19\u0E1B\u0E23\u0E30\u0E08\u0E33 (\u0E2A\u0E48\u0E27\u0E19\u0E07\u0E32\u0E19)");
		...
		Label label_13 = new Label("\u0E25\u0E32\u0E1E\u0E31\u0E01\u0E1C\u0E48\u0E2D\u0E19\u0E1B\u0E23\u0E30\u0E08\u0E33\u0E1B\u0E35");
		...
		Label lblNewLabel_7 = new Label("\u0E21\u0E35\u0E04\u0E27\u0E32\u0E21\u0E1B\u0E23\u0E30\u0E2A\u0E07\u0E04\u0E4C\u0E17\u0E35\u0E48\u0E08\u0E30\u0E25\u0E32");
		...
		Label label_7 = new Label("\u0E2A\u0E32\u0E40\u0E2B\u0E15\u0E38\u0E02\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E25\u0E32");
		...
		Label label_8 = new Label("\u0E25\u0E32\u0E15\u0E31\u0E49\u0E07\u0E41\u0E15\u0E48\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48");
		...
		Label lblNewLabel_8 = new Label("\u0E08\u0E33\u0E19\u0E27\u0E19\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E25\u0E32");
		horizontalPanel_3.add(lblNewLabel_8);
		lblNewLabel_8.setWidth("102px");
		...
		Label lblNewLabel_9 = new Label("\u0E08\u0E19\u0E16\u0E36\u0E07\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48 11  \u0E01.\u0E04.  2556");
		...
		Label lblNewLabel_10 = new Label("\u0E40\u0E1A\u0E2D\u0E23\u0E4C\u0E15\u0E34\u0E14\u0E15\u0E48\u0E2D\u0E40\u0E23\u0E48\u0E07\u0E14\u0E48\u0E27\u0E19");
		...
		comboBox_1.addItem("\u0E19\u0E32\u0E22 \u0E2A\u0E21\u0E08\u0E34\u0E15\u0E23 \u0E21\u0E32\u0E01\u0E31\u0E19\u0E41\u0E25\u0E49\u0E27");
		...
		horizontalPanel_2.setSpacing(1);
		horizontalPanel_2.setBorderWidth(1);

		flowPanel_2.add(horizontalPanel_2);
		horizontalPanel_2.setSize("174px", "28px");

		Button btnNewButton_2 = new Button("New button");
		horizontalPanel_2.setCellWidth(btnNewButton_2, null);
		horizontalPanel_2.add(btnNewButton_2);
