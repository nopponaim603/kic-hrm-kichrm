...
public class DriveServiceImpl {
	...
	private static final Logger _logger = Logger
			.getLogger(DriveServiceImpl.class.getName());
	// private static String CLIENT_SECRET = "ZGNTRofblwZ3TTnlgJ6N7eyE";

	/** Email of the Service Account */
	// public static final String SERVICE_ACCOUNT_EMAIL =
	// "392232398516-7nei78mpn8rl47pknpofrv4rtmt0id96@developer.gserviceaccount.com";
		...
		try {
			...
			if (fileContent.exists()) {
				FileContent mediaContent = new FileContent("text/plain",
						fileContent);
				// Try to throws 3
				_logger.severe("before insert File" + service.toString()
						+ " : " + service.about());
				...
				_logger.severe("InsertFile : File is not Exists.");
	...
	public static void printFile(Drive service, String fileId) {
		try {
			...
			/*
			 * InputStream test = downloadFile(service,file); Reader reader =
			 * new InputStreamReader(test); ReadCSVFile(reader);
			 */
